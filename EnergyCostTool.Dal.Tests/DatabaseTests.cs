...
namespace EnergyCostTool.Dal.Tests
{
    ...
    public class DatabaseTests
    {
        ...
        [Test()]
        public void ConvertToSolarEnergyMonthCollectionTest()
        {
            List<EnergyConsumption> energyConsumptions =
            [
                new EnergyConsumption(new DateTime(2024, 10, 1), 100, 200, 300, 400, 500, 600),
                new EnergyConsumption(new DateTime(2024, 11, 1), 1100, 1200, 1300, 1400, 1500, 1600),
                new EnergyConsumption(new DateTime(2024, 12, 1), 0, 1200, 1300, 1400, 1500, 1600),
            ];
            ...
            EnergyMonthCollection energyMonths = Database.ConvertToSolarEnergyMonthCollection(energyConsumptions, energyPrices);

            Assert.AreEqual(2, energyMonths.Get().Count, "Number of EnergyMonths should be 3");
            Assert.AreEqual(1100, energyMonths.Get()[0].Consumption.SolarGeneration, "First Solar Generation should be 1100");
            Assert.IsNull(energyMonths.Get()[0].Tariff, "First Price should not exist");
            Assert.AreEqual(100, energyMonths.Get()[1].Consumption.SolarGeneration, "Second Solar Generation should be 100");
            Assert.AreEqual(0.1, energyMonths.Get()[1].Tariff.ElectricityHigh, "Second electricity high should be 0.1");
        }
