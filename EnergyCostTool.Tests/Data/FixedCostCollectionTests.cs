...
namespace EnergyCostTool.Tests.Data
{
    ...
    public class FixedCostCollectionTests
    {
        ...
        public void AddFixedCostTest()
        {
            ...
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
        ...
        public void AddDifferentFixedCostForSameDateTest()
        {
            FixedCostCollection fixedCosts = new FixedCostCollection();
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost2 = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.TransportCostElectricity, 0.99, FixedCostTariffType.Monthly);
        ...
        public void DeleteFixedCostFromEmptyListTest()
        {
            ...
            Assert.Throws<FixedCostDoesNotExistException>(() =>fixedCosts.Delete(fixedCost));
        }
        ...
        public void DeleteIncorrectFixedCostFromNonEmptyListTest()
        {
            FixedCostCollection fixedCosts = new FixedCostCollection();
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost2 = new FixedCost(new DateTime(2023, 10, 2), FixedCostType.StandingChargeGas, 6.99, FixedCostTariffType.Monthly);

            fixedCosts.Add(fixedCost);
            Assert.AreEqual(1, fixedCosts.Count());

            Assert.Throws<FixedCostDoesNotExistException>(() => fixedCosts.Delete(fixedCost2));
            Assert.AreEqual(1, fixedCosts.Count());
        }
        ...
        public void UpdateFixedCostTest()
        {
            FixedCostCollection fixedCosts = new FixedCostCollection();
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost2 = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 6.99, FixedCostTariffType.Monthly);
        ...
        public void UpdateSameDateDifferentFixedCostTest()
        {
            FixedCostCollection fixedCosts = new FixedCostCollection();
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost2 = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.TransportCostElectricity, 6.99, FixedCostTariffType.Monthly);
        ...
        {
            FixedCostCollection fixedCosts = new FixedCostCollection();
            FixedCost fixedCost = new FixedCost(new DateTime(2023, 9, 1), FixedCostType.StandingChargeGas, 5.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost2 = new FixedCost(new DateTime(2023, 10, 1), FixedCostType.StandingChargeGas, 6.99, FixedCostTariffType.Monthly);
            FixedCost fixedCost3 = new FixedCost(new DateTime(2023, 11, 1), FixedCostType.StandingChargeGas, 7.99, FixedCostTariffType.Monthly);
